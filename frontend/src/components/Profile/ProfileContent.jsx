...
const Address = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (addressType === "" || city === "") {
      ...
      dispatch(
        updatUserAddress(city, address1, address2, zipCode, addressType)
      );
      setOpen(false);
      setCity("");
      setAddress1("");
              ...
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  <div className="w-full pb-2">
                    <label className="block pb-2">Choissisez votre Ville</label>
                    <select
                      name=""
                      id=""
                      value={city}
                    ...
                    >
                      ...
                      {State &&
                        State.getStatesOfCountry("Algeria").map((item) => (
                          <option
