...
const Checkout = () => {
  ...
  const paymentSubmit = () => {
    if (address1 === "" || address2 === "" || zipCode === null || city === "") {
      toast.error("Veuillez choisir votre adresse de livraison !");
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.get(`${server}/coupon/get-coupon-value/${name}`).then((res) => {
      ...
      if (res.data.couponCode === null) {
        toast.error("Le code promo n'existe pas !");
        setCouponCode("");
      }
    });
  };
    ...
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      <form>
        <div className="w-full flex pb-3">
          ...
          <div className="w-[50%]">
            <label className="block pb-2">Adresse e-mail</label>
            <input
              type="email"
        ...
        <div className="w-full flex pb-3">
          <div className="w-[100%]">
            ...
            >
              ...
              {State &&
                State.getStatesOfCountry("DZ").map((item) => (
      ...
      >
        Choisissez parmi les adresses enregistrées
      </h5>
      {userInfo && (
        <div>
          {user &&
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Prix Total:</h3>
      ...
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Promotion: </h3>
        <h5 className="text-[18px] font-[600]">
          - {discountPercentenge ? "$" + discountPercentenge.toString() : null}
        </h5>
      </div>
      <h5 className="text-[18px] font-[600] text-end pt-3">{totalPrice} DZD</h5>
      <br />
